...
def GUI():
    ...
    player1_name.grid(row=3, column=4,rowspan=2,columnspan=2)
    
    player2_name = Entry(root, textvariable=p2, bd=5)
    player2_name.grid(row=4, column=4,rowspan=2,columnspan=2)

    nt1=Button(root,text="New Game",font='roboto 30',bg="#CE9141", fg="#220047")
    nt1.bind("<Button-1>",newgame1)
    nt1.grid(row=5,column=4,columnspan=2)



    buttons = StringVar()

    label = Label(root, text="Player Name1:", font='roboto 25',fg="#CE9141", bg="#220047", height=1)
    label.grid(row=3, column=4)


    label = Label(root, text="Player Name2:", font='roboto 25', fg="#CE9141", bg="#220047", height=1)
